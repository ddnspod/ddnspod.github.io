...
This service offers a REST API allowing to get a visitor IPv6 address and to query location information from any IPv6-Only address. It outputs JSON-encoded IP geolocation data.
